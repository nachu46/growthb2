...
export default function AdminDashboardPage() {
  ...
  const statCards = [
    { title: 'Total Products', value: stats?.totalProducts || 0, sub: `${stats?.activeProducts || 0} active`, icon: Package, href: '/admin/products' },
    { title: 'Company Logos', value: stats?.totalCompanyLogos || 0, sub: `${stats?.activeCompanyLogos || 0} active`, icon: Building2, href: '/admin/company-logos' },
    { title: 'Supply Partners', value: stats?.totalSupplyPartners || 0, sub: 'Active partners', icon: Handshake, href: '/admin/partners' },
    { title: 'Certifications', value: stats?.totalCertifications || 0, sub: 'Tier-1 approvals', icon: Award, href: '/admin/certifications' },
    { title: 'Total Customer RFQs', value: stats?.totalRfqs || 0, sub: `${stats?.pendingRfqs || 0} pending`, icon: Inbox, href: '/admin/rfq' },
    { title: 'BOM Submissions', value: stats?.totalBoms || 0, sub: 'Uploaded files', icon: FileSpreadsheet, href: '/admin/bom' },
    { title: 'GCC Hub Locations', value: stats?.activeGccLocations || 0, sub: 'Active regional hubs', icon: MapPin, href: '/admin/locations' },
    { title: 'Technical Resources', value: stats?.totalResources || 0, sub: 'TDS & SDS PDFs', icon: FileText, href: '/admin/resources' },
  ];
          ...
          return (
            ...
            >
              <div>
                ...
                <div style={{ fontSize: '0.75rem', fontWeight: 700, color: 'var(--slate-600)', marginTop: '4px' }}>
                  {card.sub}
                </div>
              </div>
              <div style={{
